...
/* harmony import */ var _ngmodule_material_carousel__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @ngmodule/material-carousel */ "./node_modules/@ngmodule/material-carousel/fesm2015/ngmodule-material-carousel.js");
...
/* harmony import */ var _ngmodule_material_carousel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @ngmodule/material-carousel */ "./node_modules/@ngmodule/material-carousel/fesm2015/ngmodule-material-carousel.js");
...
let MainCardComponent = MainCardComponent_1 = class MainCardComponent {
    constructor(
...
let StreetviewComponent = class StreetviewComponent {
    constructor() {
        // latitude = 39.017133;
        // longitude = -77.372330;
...
module.exports = JSON.parse("[{\"id\":0,\"Name\":\"Swedish Massage\",\"Option1\":{\"time\":\"60 min\",\"price\":\"$60\"},\"Option2\":{\"time\":\"90 min\",\"price\":\"$90\"}},{\"id\":1,\"Name\":\"Deep Tissue Massage\",\"Option1\":{\"time\":\"60 min\",\"price\":\"$60\"},\"Option2\":{\"time\":\"90 min\",\"price\":\"$90\"}},{\"id\":2,\"Name\":\"Hot Stone Massage\",\"Option1\":{\"time\":\"60 min\",\"price\":\"$60\"},\"Option2\":{\"time\":\"90 min\",\"price\":\"$90\"}},{\"id\":3,\"Name\":\"Himalayan Salt Stone Massage\",\"Option1\":{\"time\":\"60 min\",\"price\":\"$60\"},\"Option2\":{\"time\":\"90 min\",\"price\":\"$90\"}},{\"id\":4,\"Name\":\"Sports Massage\",\"Option1\":{\"time\":\"60 min\",\"price\":\"$60\"},\"Option2\":{\"time\":\"90 min\",\"price\":\"$90\"}},{\"id\":5,\"Name\":\"Prenatal Massage\",\"Option1\":{\"time\":\"60 min\",\"price\":\"$60\"},\"Option2\":{\"time\":\"90 min\",\"price\":\"$90\"}},{\"id\":6,\"Name\":\"Infrared Sauna\",\"Option1\":{\"time\":\"30 min\",\"price\":\"$30\"},\"Option2\":{\"time\":\"\",\"price\":\"\"}},{\"id\":7,\"Name\":\"Relaxology\",\"Option1\":{\"time\":\"30 min\",\"price\":\"$30\"},\"Option2\":{\"time\":\"\",\"price\":\"\"}}]");
...
let VipCardComponent = class VipCardComponent {
    constructor() {
        this.displayedColumns = ['id', 'Name', 'pricing1', 'pricing2'];
        // Create 100 users
        const users = _data_json__WEBPACK_IMPORTED_MODULE_3__;
...
let WorkHoursComponent = class WorkHoursComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let MainArticleComponent = class MainArticleComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let MainIntroComponent = class MainIntroComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let RowNavComponent = class RowNavComponent {
...
let ServeItemsComponent = class ServeItemsComponent {
    constructor(router) {
        this.router = router;
        this.title = 'app';
...
ServeItemsComponent.ctorParameters = () => [
...
let ServeItems1Component = class ServeItems1Component {
    constructor(activatedRoute, router, sanitizer) {
...
ServeItems1Component.ctorParameters = () => [
...
let ServeItems2Component = class ServeItems2Component {
    constructor() { }
    ngOnInit() {
    }
};
...
let ServeItems3Component = class ServeItems3Component {
    constructor() { }
    ngOnInit() {
    }
};
...
let TailComponent = class TailComponent {
    constructor() { }
    ngOnInit() {
    }
};
